...
easygui.buttonbox("Choose your file to be proccessed (Excel File)",choices=("NEXT","CONTINUE","LETS GO"))
...
Productivity_rel_EGB9 = (Productivity_abs_EGB9/148) / cont_relEGB9
Productivity_rel_EGB10 = (Productivity_abs_EGB10/148) / cont_relEGB10
